<template>
  ...
  <div class="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
      ...
      <div class="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
          <div>
              <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900 border-2 rounded-[60px] border-black">
              ...
              <h3 class="mb-2 text-xl font-bold dark:text-white">Windows</h3>
          ...
          <div>
              ...
              <h3 class="mb-2 text-xl font-bold dark:text-white">MacOS</h3>
          ...
          <div>
              ...
              <h3 class="mb-2 text-xl font-bold dark:text-white">Linux</h3>
