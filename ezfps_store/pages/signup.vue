  ...
  <section class="bg-gray-50 dark:bg-gray-900 ">
    <div v-if="emailverification == true" id="alert-2"
      ...
      <div class="ml-3 text-sm font-medium hidden sm:flex">
        Спасибо за регистрацию, войдите в аккаунт<a href="/signin"
          class="font-semibold underline hover:no-underline">здесь</a>
      </div>
    </div>
            ...
            <div class="flex items-start">
              ...
              <div class="ml-3 text-sm">
                <label for="terms" class="font-light text-gray-500">Я принимаю <a
                    class="font-medium text-orange-600 hover:underline ">Правила и соглашения</a></label>
              </div>
            </div>
            <button type="submit"
              class="w-full text-white bg-orange-600 hover:bg-orange-700 focus:ring-4 focus:outline-none focus:ring-orange-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center">Зарегистрироваться</button>
            <p class="text-sm font-light text-gray-500 ">
              Уже есть аккаунт? <NuxtLink to="/signup"><a class="text-orange-600 hover:underline font-medium">Войдите</a>
              </NuxtLink>
            </p>
          </form>
        </div>
