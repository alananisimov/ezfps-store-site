    ...
    <nav class="mx-auto flex z-50 max-w-7xl items-center justify-between p-6 lg:px-8" aria-label="Global">
      <div class="flex lg:flex-1 relative">
        <a href="#" class="-m-1.5 p-1.5">
          ...
          <NuxtLink to="/"><img class="h-8 w-auto" src="https://i.ibb.co/f2QNQp0/icon.png" alt="" /></NuxtLink>
        </a>
      </div>
        ...
        <div class="mt-6 flow-root">
          <div class="-my-6 divide-y divide-gray-500/10">
            <div class="space-y-2 py-6">
              ...
              <NuxtLink to="/introduction"><a href="#" class="-mx-3 block rounded-lg px-3 py-2 text-base font-semibold leading-7 text-gray-900 hover:bg-gray-50">Get Started</a></NuxtLink>
            </div>
            <div class="py-6">
