...
<template>
<div class="w-[48rem] max-w-none rounded-xl shadow-xl ring-1 ring-gray-400/10 hidden lg:block h-[48rem] -mt-10">
    <TresCanvas shadows alpha>
      ...
      <TresDirectionalLight :position="[5, 5, 5]" :intensity="5" cast-shadow />
      <TresDirectionalLight :position="[-5, 5, -5]" :intensity="5" cast-shadow />
    </TresCanvas>
</div>
</template>